...
def gameloop():
    ...
    while True:
        ...
        pygame.draw.rect(gamewindow,blue,[560,220,20,160])
        ...
        if manx >= g1x - 25 and manx <= g1x + 25:
            if many >= g1y - 25 and many <= g1y + 25:
